...
/*
  ...
  //key of age with the value being your age.  Then alert your name 
  //using dot notation.
*/
...
/*
  ...
  //food, person, book, movie, holiday. Have the values to those keys 
...
/*
  ...
  //value being your favorite car and then another key named 'brand' 
...
/*
  Now change the value of the food key in your favoriteThings object to 
  //be 'Chicken Nuggets' and change the value of the book key in your 
...
/* 
  ...
  //'firstPocket'. Using bracket notation, add a 'firstPocket' key 
  //(or property) to backPack, using 'item'. Set the value of that key
  // to 'chapstick'. Using dot notation, add another key (or property) 
  //to your backPack object that is named color, with the value being 
...
Instead, console.log your whole backPack object and then check out the 
//console. 
*/
...
/* 
  ...
  //to the following: name -> 'Tyler S. McGinnis' and email -> 'tyler.mcginnis@devmounta.in'. 
...
/*
  ...
  //your methodCollection object. One called 'alertHello' which alerts 
  //'hello' and another method called 'logHello' which logs 'hello' to
  // the console. 
*/
...
/* 
  ...
  //ssn as its parameters. Return a new object with all of the 
